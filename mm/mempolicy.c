...
int mempolicy_set_node_perf(unsigned int node, struct access_coordinate *coords)
{
	...
	old_bw = rcu_dereference_protected(node_bw_table,
...
reduce:
	...
	goto reduce;
leave:
	rcu_assign_pointer(node_bw_table, new_bw);
