...
PAGE_SIZE multiple when read back.
  ...
  memory.interleave_weights
	An array of weights to be used for interleaving when mempolicy
	utilizes MPOL_F_IL_WEIGHTING.
	...
	When a mempolicy does not use the MPOL_F_IL_WEIGHTING flag,
	these weights not used.
